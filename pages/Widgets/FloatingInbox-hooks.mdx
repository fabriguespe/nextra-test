...
# Floating Inbox (React Hooks)

The `Inbox` widget is a floating messaging component designed to allow for integrating web3 messaging in any website. Uses React SDK hooks.
