...
### Step 1: Import XMTP Client and Ethers Library
...
### Step 2: Set up the `walletAddresses` Array
...
_For more information check the [FAQs](https://xmtp.org/docs/faq#how-does-network-rate-limiting-work)_

### Step 4: Check which addresses can receive messages
...
### Step 5: Loop through wallet address array to broadcast
