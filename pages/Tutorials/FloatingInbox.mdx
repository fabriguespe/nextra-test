...
That's a high-level overview of how to create a floating inbox widget using XMTP. Customize it further according to your requirements.

#### Reference Widget

For a complete working example, please refer to this complete widget page.

- [FloatingInbox Widget](/Widgets/FloatingInbox)
